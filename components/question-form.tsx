    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Create multiple questions for your quiz system</p>
        </div>
        <div className="text-sm text-gray-500">Total Questions: {questions.length}</div>
      </div>
      ...
      {questions.map((question, index) => (
        <Card key={question.id} className="border border-gray-200">
          <CardHeader className="pb-4">
            <div className="flex justify-between items-center">
              <CardTitle className="text-lg font-semibold text-gray-800">Question {index + 1}</CardTitle>
              {questions.length > 1 && (
                <Button
                  variant="outline"
                  size="sm"
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor={`optionA-${question.id}`} className="text-sm font-medium text-gray-700">
                  Option A
                </Label>
                <Input
              ...
              <div>
                <Label htmlFor={`optionB-${question.id}`} className="text-sm font-medium text-gray-700">
                  Option B
                </Label>
                <Input
              ...
              <div>
                <Label htmlFor={`optionC-${question.id}`} className="text-sm font-medium text-gray-700">
                  Option C
                </Label>
                <Input
              ...
              <div>
                <Label htmlFor={`optionD-${question.id}`} className="text-sm font-medium text-gray-700">
                  Option D
                </Label>
                <Input
      ...
      <div className="flex flex-col sm:flex-row gap-4 pt-6">
        ...
        <Button onClick={handleSubmitAll} className="bg-blue-500 hover:bg-blue-600 text-white px-8">
